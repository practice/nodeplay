...
import org.nodeplay.node.web.AppUserController;
...
privileged aspect AppUserController_Roo_Controller {
    ...
    void AppUserController.addDateTimeFormatPatterns(Model uiModel) {
        uiModel.addAttribute("appUser_created_date_format", DateTimeFormat.patternForStyle("S-", LocaleContextHolder.getLocale()));
        uiModel.addAttribute("appUser_lastaccess_date_format", DateTimeFormat.patternForStyle("S-", LocaleContextHolder.getLocale()));
        uiModel.addAttribute("appUser_lastlogin_date_format", DateTimeFormat.patternForStyle("S-", LocaleContextHolder.getLocale()));
    }
